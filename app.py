...
response  = requests.get("https://raw.githubusercontent.com/saiveerendranath/capstone-project/master/HGBR_pipeline.pkl")
HBGR_pipeline = joblib.load(BytesIO(response.content))
...
def predict(data: InputData):
    ...
    'Style' 
        ...
        host='yamabiko.proxy.rlwy.net',        # your database host
        port='27163',
        user='root',    # your database username
        password='NmqgJstsBFtVdQMfZMFNuIdBOTbvTSQw',# your database password
